...
CREATE PROCEDURE `spAddBook`(IN _SINOPSIS TEXT, IN _TITULO VARCHAR(50), IN _FECHA_PUBLICACION DATE, IN _NUM_SERIE INT, IN _COD_GENERO INT, IN _COD_AUTOR INT)
BEGIN
    INSERT INTO libro (SIPNOPSIS, TITULO, FECHA_PUBLICACION, NUM_SERIE, COD_GENERO, COD_AUTOR)
    VALUES (_SINOPSIS, _TITULO, _FECHA_PUBLICACION, _NUM_SERIE, _COD_GENERO, _COD_AUTOR);
END //
DELIMITER ;
CALL `spAddBook`(_SINOPSIS, _TITULO, _FECHA_PUBLICACION, _NUM_SERIE, _COD_GENERO, _COD_AUTOR)

DELIMITER //

CREATE PROCEDURE `spUpdateBook`(IN _COD_LIBRO INT, IN _SINOPSIS TEXT, IN _TITULO VARCHAR(50), IN _FECHA_PUBLICACION DATE, IN _NUM_SERIE INT, IN _COD_GENERO INT, IN _COD_AUTOR INT)
BEGIN
    UPDATE libro
    SET SIPNOPSIS = _SINOPSIS, TITULO = _TITULO, FECHA_PUBLICACION = _FECHA_PUBLICACION, NUM_SERIE = _NUM_SERIE, COD_GENERO = _COD_GENERO, COD_AUTOR = _COD_AUTOR
    WHERE COD_LIBRO = _COD_LIBRO;
END //
DELIMITER ;
CALL `spUpdateBook`(_COD_LIBRO, _SINOPSIS, _TITULO, _FECHA_PUBLICACION, _NUM_SERIE, _COD_GENERO, _COD_AUTOR )
