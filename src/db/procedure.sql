...
CREATE PROCEDURE `spAddBook`(IN _SINOPSIS TEXT, IN _TITULO TEXT, IN _FECHA_PUBLICACION DATE, IN _NUM_SERIE INT, IN _COD_GENERO INT, IN _COD_AUTOR INT)
BEGIN
...
CREATE PROCEDURE `spUpdateBook`(IN _COD_LIBRO INT, IN _SINOPSIS TEXT, IN _TITULO TEXT, IN _FECHA_PUBLICACION DATE, IN _NUM_SERIE INT, IN _COD_GENERO INT, IN _COD_AUTOR INT)
BEGIN
    UPDATE libro
    SET SIPNOPSIS = _SINOPSIS,
      TITULO = _TITULO,
